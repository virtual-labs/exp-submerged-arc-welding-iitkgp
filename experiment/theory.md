...
- ***Flux:*** The molten weld is shielded from potential ambient contamination by granulated flux, which acts as a shield. The granulation of flux is of a specific size. It could be mechanically combined, fused, or bonded. The flux may contain calcium fluorides and oxides of calcium, magnesium, silicon, aluminum, and manganese. Substances that give off much gas when they are welded are never mixed with the flux. Welding thicker and thinner pieces requires small and large particle sizes of flux, respectively. There are different types of fluxes such as fused flux, bonded flux (silicate based), alloying flux (contains Mn, Mo, Ni, Cr) etc. Based on material property, different fluxes can be used like for carbon steel, bonded or fused flux can be used for smooth weld bead and better penetration. For low-alloy steels, alloying or bonded flux can be used in which controlled addition of Mn, Mo, or Cr depending on alloy grade which helps in avoid cracking.
